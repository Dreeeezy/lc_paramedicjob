...
emP = Tunnel.getInterface("lc_paramedicjob")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = nil
...
local CoordenadaX = 350.9  
local CoordenadaY = -588.38
local CoordenadaZ = 28.8
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("ghispo3")) then
				skips = 1
